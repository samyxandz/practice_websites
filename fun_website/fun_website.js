function clearAll() {
 ...
 function showQuote() {
   ...
   y.textContent="quote: ' "+randomQuote.quote+" '";
   z.textContent="- "+randomQuote.author;
   clearAll();
 ...
 function showRiddle() {
   ...
   const y=document.createElement('p');
   y.textContent="The answer is : "+answer;
   y.hidden="true";
   y.setAttribute('id','riddle-answer');
   clearAll();
   container.appendChild(x);
   container.appendChild(y);
